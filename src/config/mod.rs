...
pub use schema::{
    ...
    IdentityConfig, LarkConfig, MatrixConfig, MemoryConfig, ModelProviderConfig, ModelRouteConfig,
    MultimodalConfig, NextcloudTalkConfig, ObservabilityConfig, OtpConfig, OtpMethod,
    PeripheralBoardConfig, PeripheralsConfig, ProviderConfig, ProxyConfig, ProxyScope, QdrantConfig,
    ...
    TranscriptionConfig, TunnelConfig, WasmConfig, WebFetchConfig, WebSearchConfig, WebhookConfig,
};
